...
var hls_2025 = hls.filterDate("2016-01-01","2025-08-22");

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

print(ui.Chart.image.seriesByRegion({imageCollection: hls_2025.map(ndti), regions: loc1_box1km, reducer: ee.Reducer.median(),
