...
var img_19 = ee.Image(landvi.toList(landvi.size()).get(19));
var img_20 = ee.Image(landvi.toList(landvi.size()).get(20));
...
Export.image.toDrive({'image': landvi_img.toUint16(), 'region': roi, 'scale': 2000,
        ...
        'fileNamePrefix': 'mes_pace_oci_landvi__202403_202511_gcs', 'crs': 'EPSG:4326', 'maxPixels': 1e13});
