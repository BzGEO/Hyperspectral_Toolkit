...
var img1 = a.emit_sr2(roi,"2025-06-15T00:00","2025-06-15T23:59"); // Single date
var img2 = a.emit_sr2(roi,"2022-01-01T00:00","2025-12-31T23:59"); // Mosaic of multiple dates
...
Map.addLayer(img1, a.viz1_emit, 'EMIT SR all', 1);
...
Map.addLayer(unsuper(img1, 10).randomVisualizer(), {},'Unsupervised classif. (10)', 0);
