...
var emit_collection = ee.ImageCollection('NASA/EMIT/L2A/RFL').select(ee.List.sequence(0, 284)).select(b.bands_emit_orig,b.bands_emit_mod).filterBounds(c.roi_bz);
...
var titlePanel = ui.Panel({
    widgets: [
        ...
        ui.Label("credits: based on Dr. Sam Roy's TANAGER Viewer", {stretch:'horizontal',textAlign:'center',fontSize: '12px', fontStyle: 'italic', color: 'lightskyblue'},
