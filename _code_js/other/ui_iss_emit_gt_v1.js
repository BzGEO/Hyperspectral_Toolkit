...
var emit_collection = ee.ImageCollection('NASA/EMIT/L2A/RFL').select(ee.List.sequence(0, 284)).select(b.bands_emit_orig,b.bands_emit_mod).filterBounds(c.roi_gt);
...
var spectralPanel = ui.Panel({widgets: [
        ...
        ui.Label({value: 'Default olor order: red, green, blue, yellow, magenta, cyan, orange, purple, black', style: {fontSize: '9px', color: 'grey', fontStyle: 'italic'}}),
        ],
